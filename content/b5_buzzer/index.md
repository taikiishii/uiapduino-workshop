...
![7番ピンとGNDにつなぐ。向きはどちらでもOK](image/index/bb_buzzer.png)

---

# なぜ 7番ピン？
`tone()` は**どのピンでも鳴らせる**。だからこそ、選び方に理由があるんだ。

明るさを変えられる **`0` `2` `5` `6` `12`** には、**そのピンにしかできないこと**がある。
音はどこでも鳴るから、そちらはゆずっておこう。

- のこりの **`3` `4` `7` `8` `9` `10`** なら、どれを使ってもいい
- このワークショップ資料では、そのうちの **7番**をえらんだよ

>| ⚠ `tone()` が使えるのは、**プログラム全体で1つのピンだけ**。
> ブザーを2つつないでも、**同時に鳴らすことはできない**んだ。

> 「その部品にしかできないこと」を考えてピンを割りふる。これも工夫だよ。
...
4. 音に合わせて**LEDも光る**ようにする
5. b2 のスイッチで、**押すと鳴る楽器**を作る
