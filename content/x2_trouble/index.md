...
> ⚠ ジャンパーワイヤーが**断線**していることもある。別の線に替えてみよう。
...
# 反応が小さいとき
「動いてはいるけど、差がよく分からない」とき。

1. **いちばん明るいとき**と**いちばん暗いとき**の値を2つ測る
2. 差が小さければ、**センサーへの刺激が足りていない**
3. しきい値は、その**2つの値のまん中**にする

> ⚠ CdS は**指を1本のせるだけでは光が入る**。
> 手をカップのように丸めて、すきまなくかぶせよう。

> 差が出ないのは部品の故障より、**測り方**のことが多いよ。
...
> ⚠ **電池からサーボに電気を送る**。GND だけボードとつなぐ（e5）。
...
- **部品をかえる** … LED・ジャンパーワイヤー・ブレッドボードを別のものに
